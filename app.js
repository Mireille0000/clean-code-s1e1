...
var taskInput=document.getElementById("add-item__new-item");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="tasks__button_edit";

    deleteButton.className="tasks__button_delete";
